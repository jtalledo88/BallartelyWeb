...
public class ProveedorMB {
	...
	public void agregarProveedor() {
		...
		try {
			...
			objProveedor.setProviderCreationDate(new Date());
			
			sMensaje = this.proveedorService.agregarProveedor(objProveedor);
	...
	public void editarProveedor() {
		...
		try {
			...
			this.objProveedorMain.setProviderModificationDate(new Date());
			sMensaje = this.proveedorService.editarProveedor(this.objProveedorMain);
			Utilitarios.mensaje("", sMensaje);
			this.canRegTablaPrincipal = getListaPrincipalProveedores();
	...
	public void eliminarProveedor() {
		String sMensaje = "";
		try {
			sMensaje = this.proveedorService.eliminarProveedor(this.objProveedorMain);
			setLstProveedoresMain(new ArrayList<Provider>());
			this.canRegTablaPrincipal = getListaPrincipalProveedores();
			Utilitarios.mensaje("", sMensaje);
		} catch (BallartelyException e) {
